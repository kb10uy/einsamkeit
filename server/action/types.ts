...
export const DbKeysRemoteNotes = ['id', 'created_at', 'updated_at', 'object_id', 'remote_user_id', 'body_html', 'is_public', 'is_sensitive', 'warning_text'];
export const DbKeysRemoteMedia = ['id', 'created_at', 'updated_at', 'remote_note_id', 'type', 'url'];
